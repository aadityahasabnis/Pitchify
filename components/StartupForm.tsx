...
const StartupForm = () => {
    ...
    return (
        <form action={formAction} className={'startup-form'}>
            ...
            <div data-color-mode={'light'} className={'justify-center'}>
                ...
                />
                <h2 className={'text-center text-2xl font-black'}>Preview</h2>
            ...
            <Button
                type={'submit'}
                className={'startup-form_btn text-white hover:cursor-pointer'}
                disabled={isPending}
            >
